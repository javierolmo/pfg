...
public class SpecsConsumer {
    ...
    @KafkaListener(topics = "melodia.backend.specs.boogie", groupId = "0", containerFactory = "boogieSpecsKafkaListenerFactory")
    public void consume(BoogieSpecs specs, @Header(KafkaHeaders.RECEIVED_MESSAGE_KEY) String key) {
        /*
        File xmlFile = null;
        File pdfFile = null;
        try{
