...
public class MelodiaScore {
    ...
    public MelodiaScore(UserSpecs userSpecs){
        this.userSpecs = userSpecs;
        this.movementNumber = userSpecs.getMovementNumber();
        this.movementTitle = userSpecs.getMovementTitle();
        this.authors = userSpecs.getAuthors().toArray(new String[]{});
        this.estructura = new Estructura(userSpecs);
